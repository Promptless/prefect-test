...
**Note**: The system now checks for active workers in the specified work pool before displaying setup instructions. If active workers are detected, setup instructions may be omitted.
### Configure prefetch
